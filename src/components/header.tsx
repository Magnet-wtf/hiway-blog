...
export default function Header() {
    ...
    return (
        <div className={'w-full flex flex-col'}>
            ...
            <Dialog open={mobileMenuOpen} onOpenChange={() => setMobileMenuOpen(!mobileMenuOpen)}>
                <div className='fixed inset-0 z-50' />
                <DialogContent className='fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm'>
                    ...
                    <div className='mt-6 flow-root'>
                        <div className='-my-6'>
                            <div className='space-y-2 py-6'>
                                ...
                                <ListItem href='https://hiway.fr/simulateur?s=salarieClientFinal' title='Simulation revenu de freelance' />
                                <ListItem href='/' title='Blog' />
                            </div>
